...
export const messages = {
  de: {
    ...
    "home.passportIncomplete": "Jetzt ausfüllen — für den Notfall",
    "home.doseMissed": "Dosis vergessen",
    "home.confirmNow": "Jetzt bestätigen",
    "home.dosesPending": "Noch {count} Dosis ausstehend",
    ...
    "settings.textSizeSubtitle": "Normal oder Groß für bessere Lesbarkeit",
  ...
  en: {
    ...
    "home.dosesPending": "{count} dose(s) still pending",
    ...
    "settings.textSizeSubtitle": "Normal or large for easier reading",
    "settings.normal": "Normal",
